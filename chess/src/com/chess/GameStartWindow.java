...
public class GameStartWindow extends JFrame {
    public GameStartWindow() {
        ...
        setLocationRelativeTo(null);//放置窗口的相对位置
    }

    private void btn_gameStart(ActionEvent e) {//选择难度
        int diff = 0;
        ...
        GameWindow gameWindow = new GameWindow(radioBlack.isSelected(),diff);//难度设置，参数传递到GameWindow
    ...
    private void initComponents() { //UI控件初始化
        ...
        //======== this ========
        setTitle("\u4e94\u5b50\u68cb\u6e38\u620f");//Unicode编码：五子棋游戏
